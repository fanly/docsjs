...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    console.log(
      "  - Knowledge-base profile exists:",
      engine.getProfile("knowledge-base") !== undefined,
    );
    console.log("  - Exam-paper profile exists:", engine.getProfile("exam-paper") !== undefined);
    console.log(
      "  - Enterprise profile exists:",
      engine.getProfile("enterprise-document") !== undefined,
    );
  ...
  try {
    ...
    console.log(
      ...
      engine.getPlugin("mock-plugin")?.name === "mock-plugin",
    );
