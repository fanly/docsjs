...
describe("Plugin System", () => {
  ...
  describe("Cleanup Plugins", () => {
    it("google-docs-cleanup removes GUID artifacts", () => {
      const plugin = createGoogleDocsCleanupPlugin();
      const html =
        '<b id="docs-internal-guid-123">Test</b><span data-sheets-value="test">Content</span>';
    ...
    it("google-docs-cleanup removes Sheets HTML origin", () => {
      const plugin = createGoogleDocsCleanupPlugin();
      const html =
        '<google-sheets-html-origin><table><td data-sheets-value="1">Test</td></table></google-sheets-html-origin>';
    ...
    it("word-cleanup removes MSO inline styles", () => {
      ...
      const html =
        '<p style="mso-fareast-font-family:Calibri" class="MsoNormal"><o:p>Test</o:p></p>';
  ...
  describe("Transform Plugins", () => {
    ...
    describe("MathMl Plugin", () => {
      it("skips transformation when mathML feature disabled", () => {
        ...
        const config = {
          ...defaultPluginConfig,
          features: { ...defaultPluginConfig.features, mathML: false },
        };
    ...
    describe("AnchorCollision Plugin", () => {
      it("skips transformation when anchors feature disabled", () => {
        ...
        const config = {
          ...defaultPluginConfig,
          features: { ...defaultPluginConfig.features, anchors: false },
        };
        const context = { ...mockContext, config };
        const html = "<p>Content</p>";
      ...
      it("returns unchanged HTML when single anchor present", () => {
        const plugin = createAnchorCollisionPlugin();
        const html =
          '<img src="test.png" data-word-anchor="1" style="left:100px;top:100px;width:50px;height:50px;">';
