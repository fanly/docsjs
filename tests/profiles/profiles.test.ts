...
describe("ProfileManager", () => {
  ...
  it("should validate profiles", () => {
    ...
    const invalidProfiles = [
      ...
      {
        ...validProfile,
        security: { ...validProfile.security, sanitizerProfile: "invalid" as any },
      },
      // Invalid domain
      {
        ...validProfile,
        security: { ...validProfile.security, allowedDomains: ["invalid domain"] },
      },
  ...
  it("should handle profile exports and imports", () => {
    ...
    expect(importedProfile.parse.performance.chunkSize).toBe(
      testProfile.parse.performance.chunkSize,
    );
  });
